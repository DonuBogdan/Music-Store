...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <%--<div class="item active">--%>
            ...
            <%--<div class="container">--%>
                <%--<div class="carousel-caption">--%>
                    <%--<h1>Welcome to Bogdan's Music Store</h1>--%>
        ...
        <%--</div>--%>
            ...
            <div class="item active">
                <div align="center">
                    <video autoplay loop width="1500" height="840">
                        <source src="<c:url value="/resources/video/myVideo1.mp4" />" type="video/mp4">
                ...
                <p>Here you can buy Instruments, Records and music related Accessories. Order now for
                your Amazing New Kit!</p>
